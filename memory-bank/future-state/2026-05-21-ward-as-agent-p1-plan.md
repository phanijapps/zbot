...
**Reference:** design doc `memory-bank/future-state/2026-05-21-ward-as-agent-design.md` (§4 Gap A). The parked branch `feat/ward-as-skill` commit `48335eaa` is a Phase 3a sketch — adapted here, with `ZBOT.md` removed.
