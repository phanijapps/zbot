...
//!
//! ## Example Connectors
//! - Gmail Bridge: Send emails, receive email triggers
//! - Slack Bridge: Post messages, receive slash commands
//! - WhatsApp Bridge: Send/receive WhatsApp messages
//! - Signal Bridge: Secure messaging integration
//! - Custom CLI tools: Local scripts for automation
