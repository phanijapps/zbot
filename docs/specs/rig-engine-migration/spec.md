...
- [ ] Existing store crates are rehomed or renamed away from `zero-stores*`/`zero_stores*` while preserving schema compatibility, store traits, conformance tests, and memory/knowledge behavior.
