...
import { Plug, Plus, Trash2, Key, Globe, Cpu, Check, X, Play, Loader2 } from "lucide-react";
              ...
              <div className="bg-[var(--card)] rounded-xl p-4 card-shadow">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {selectedProvider.models.map((model) => (
                    <span
                      key={model}
                      className="inline-flex items-center px-2 py-0.5 bg-[var(--muted)] rounded text-xs text-[var(--muted-foreground)]"
                    >
                      {model}
                    </span>
                  ))}
